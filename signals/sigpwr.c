...
SIGPWR => using powerd , wheenever main PWR is shutdown and the UPS is also about to be drained off completely then powerd send this signal to init process,
then init task perform shutdown
*/
#include <string.h>
#include <unistd.h>
#include <stdio.h>
